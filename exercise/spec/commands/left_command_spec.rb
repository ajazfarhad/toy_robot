...
RSpec.describe 'LEFT command' do
  ...
  context 'when facing NORTH' do
    ...
    it 'rotates the robot to the left, changing direction to WEST' do
  ...
  context 'when facing EAST' do
    ...
    it 'rotates the robot to the left, changing direction to NORTH' do
      command_processor.process('LEFT')
  ...
  context 'when facing SOUTH' do
    ...
    it 'rotates the robot to the left, changing direction to EAST' do
      command_processor.process('LEFT')
  ...
  context 'when facing WEST' do
    ...
    it 'rotates the robot to the left, changing direction to SOUTH' do
      command_processor.process('LEFT')
